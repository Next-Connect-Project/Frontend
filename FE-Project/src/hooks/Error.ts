...
export const PrintError = (error: number) => {
    ...
    else if (error ===2){return "모집 구분을 선택 해주세요."}
    else if (error ===3){return "모임 목적 항목을 입력 해주세요.";}
    else if (error ===4){return "기술 스택을 한가지 이상 선택 해주세요.";}
    else if (error ===5){return "모집 마감일을 선택 해주세요.";}
    else if (error ===6){return "모집인원은 총합 1명 이상 이어야 합니다.";}
    else if (error ===7){return "진행 방식을 선택 해주세요.";}
    else if (error ===8){return "진행 기간을 선택 해주세요.";}
    else if (error ===9){return "모임 시간 및 장소를 입력 해주세요.";}
    else if (error ===10){return "진행 방법을 입력 해주세요.";}
    else if (error === 11) { return "연락 방법을 입력해주세요."; }
    else {
